...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'about.p2': 'Studio à taille humaine pensé pour grandir, Kilsi AI accompagne entreprises, institutions et porteurs de projets sur l\'ensemble de la chaîne de valeur logicielle et data — du développement web à l\'intelligence artificielle.',
    ...
    'services.subheading': 'De l\'architecture jusqu\'au déploiement, Kilsi AI conçoit des solutions robustes, élégantes et prêtes à passer à l\'échelle.',
    ...
    'team.founder.bio': 'Passionné par l\'intelligence artificielle et son potentiel transformateur pour l\'Afrique, Joshua est le visionnaire derrière Kilsi AI. Son ambition : bâtir une excellence technologique en Afrique de l\'Ouest et la faire rayonner dans le monde.',
  ...
  en: {
    ...
    'about.p2': 'A human-sized studio designed to grow, Kilsi AI supports companies, institutions, and project holders across the entire software and data value chain—from web development to artificial intelligence.',
    ...
    'services.subheading': 'From architecture to deployment, Kilsi AI designs robust, elegant, and scale-ready solutions.',
    ...
    'team.founder.bio': 'Passionate about artificial intelligence and its transformative potential for Africa, Joshua is the visionary behind Kilsi AI. His ambition: to build technological excellence in West Africa and make it shine across the world.',
